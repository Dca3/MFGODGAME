        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BaseWeaponDamage = table.Column<int>(type: "integer", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StoryJson = table.Column<string>(type: "jsonb", nullable: false),
                    ...
                    NpcName = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Player1Hp = table.Column<double>(type: "double precision", nullable: false),
                    Player2Hp = table.Column<double>(type: "double precision", nullable: false),
                    Player1MaxHp = table.Column<double>(type: "double precision", nullable: false),
                    Player2MaxHp = table.Column<double>(type: "double precision", nullable: false),
                    ActionsJson = table.Column<string>(type: "jsonb", nullable: false),
                    Status = table.Column<int>(type: "integer", nullable: false),
                    WinnerId = table.Column<Guid>(type: "uuid", nullable: true),
                    LogJson = table.Column<string>(type: "jsonb", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Duels_Players_Player1Id",
                        column: x => x.Player1Id,
                        principalTable: "Players",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Duels_Players_Player2Id",
                        column: x => x.Player2Id,
                        principalTable: "Players",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Duels_Players_WinnerId",
                        column: x => x.WinnerId,
                        principalTable: "Players",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RollDataJson = table.Column<string>(type: "jsonb", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    PlayerId = table.Column<Guid>(type: "uuid", nullable: false),
                    Karizma = table.Column<int>(type: "integer", nullable: false),
                    Guc = table.Column<int>(type: "integer", nullable: false),
                    Zeka = table.Column<int>(type: "integer", nullable: false),
                    Hayat = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MMRSnapshot = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Leaderboards_Seasons_SeasonId",
                        column: x => x.SeasonId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DuelActions", x => x.Type);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PlayerQuestProgress", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PlayerQuestProgress_PlayerQuests_PlayerQuestId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Leaderboards_SeasonId_PlayerId",
                table: "Leaderboards",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PlayerQuestProgress_PlayerQuestId_StepIndex",
                table: "PlayerQuestProgress",
                columns: new[] { "PlayerQuestId", "StepIndex" });
